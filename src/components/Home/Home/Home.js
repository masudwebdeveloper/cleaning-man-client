...
const Home = () => {
   ...
   return (
      <div>
         ...
         <div>
            <div className="carousel h-[250px] lg:h-[500px] container mx-auto">
               {
         ...
         <div>
            <div className='grid grid-cols-1 lg:grid-cols-5 mb-10 mt-20 container mx-auto'>
               ...
               <div className='col-span-3 text-center' data-aos="fade-left" data-aos-duration="2000">
                  <h1 className='text-5xl font-bold mb-10 text-gray-600'>Cleaning With a Conscience</h1>
                  <hr />
            ...
            <div className='flex flex-col lg:flex-row items-center bg-emerald-400 p-5 justify-center pt-8' data-aos="fade-up" data-duration="2000">
